...
public partial class BarberShopContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCita).HasName("PK__cita__814F31267361EE2A");
            ...
            entity.Property(e => e.FechaHoraReprogramada)
                .HasColumnType("datetime")
                .HasColumnName("fechaHoraReprogramada");
            ...
            entity.HasOne(d => d.IdServicioNavigation).WithMany(p => p.Cita)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__cita__idServicio__4316F928");

            entity.HasOne(d => d.IdSucursalNavigation).WithMany(p => p.Cita)
                .HasForeignKey(d => d.IdSucursal)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__cita__idSucursal__440B1D61");
        });

        modelBuilder.Entity<Direccion>(entity =>
        {
            entity.HasKey(e => e.IdDireccion).HasName("PK__direccio__B49878C9D3442CC6");
        ...
        {
            entity.HasKey(e => e.IdEstadoCita).HasName("PK__estadosC__FDA623A1B319B31C");
        ...
        {
            entity.HasKey(e => e.IdFactura).HasName("PK__factura__3CD5687E63009764");
            ...
            entity.HasOne(d => d.IdClienteNavigation).WithMany(p => p.Factura)
                .HasForeignKey(d => d.IdCliente)
                .HasConstraintName("FK__factura__idClien__44FF419A");
            ...
            entity.HasOne(d => d.IdSucursalNavigation).WithMany(p => p.Factura)
                .HasForeignKey(d => d.IdSucursal)
                .HasConstraintName("FK__factura__idSucur__45F365D3");
        });

        modelBuilder.Entity<FacturaProducto>(entity =>
        {
            entity.HasKey(e => e.IdFacturaProducto).HasName("PK__facturaP__C341F2359992BDE7");
            ...
            entity.HasOne(d => d.IdProductoNavigation).WithMany(p => p.FacturaProducto)
                ...
                .HasConstraintName("FK__facturaPr__idPro__47DBAE45");
        });

        modelBuilder.Entity<FacturaServicio>(entity =>
        {
            entity.HasKey(e => e.IdFacturaServicio).HasName("PK__facturaS__7C194415BB75799F");
            ...
            entity.HasOne(d => d.IdServicioNavigation).WithMany(p => p.FacturaServicio)
                .HasForeignKey(d => d.IdServicio)
                .HasConstraintName("FK__facturaSe__idSer__49C3F6B7");
        });
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__producto__07F4A1324092FE04");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__rol__3C872F76F9F94344");
        ...
        {
            entity.HasKey(e => e.IdSevicio).HasName("PK__servicio__104D67DBAC574F66");
        ...
        {
            entity.HasKey(e => e.IdSucursal).HasName("PK__sucursal__F707694CDF2BAE48");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__usuario__645723A6A737EF51");
            ...
            entity.HasOne(d => d.IdSucursalNavigation).WithMany(p => p.Usuario)
                .HasForeignKey(d => d.IdSucursal)
                .HasConstraintName("FK__usuario__idSucur__5070F446");
        });
